    ...
    <div className="safe-pt pb-12 min-h-full">
      <div className="site-container pt-2 lg:pt-10 max-w-2xl">
        <header className="flex items-center gap-3 pb-6 lg:pb-8">
          ...
          <h1 className="text-xl lg:text-3xl font-semibold tracking-tight">Terms of Use</h1>
        </header>

        <article className="space-y-4 text-[15px] lg:text-base leading-relaxed text-zinc-700 dark:text-zinc-300">
