...
export function PrivacyPage() {
  return (
    <div className="safe-pt pb-12 min-h-full">
      <div className="site-container pt-2 lg:pt-10 max-w-2xl">
        <header className="flex items-center gap-3 pb-6 lg:pb-8">
          ...
          <h1 className="text-xl lg:text-3xl font-semibold tracking-tight">Privacy Policy</h1>
        </header>

        <article className="prose-sm space-y-4 text-[15px] lg:text-base leading-relaxed text-zinc-700 dark:text-zinc-300 max-w-2xl">
          ...
          <h2 className="text-base lg:text-lg font-semibold text-zinc-900 dark:text-zinc-50 pt-2">
            What we collect
          </h2>
