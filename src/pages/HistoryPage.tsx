  ...
  return (
    <div className="safe-pt safe-px px-5 pb-6 min-h-full">
      <header className="pt-4 pb-5">
        ...
        <h1 className="text-3xl font-semibold tracking-tight mt-1">History</h1>
      ...
      <ul className="space-y-3 animate-fade-up">
        ...
        <li>
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-3xl bg-white dark:bg-zinc-900 ring-1 ring-black/5 dark:ring-white/10 text-left active:scale-[0.99] transition"
          >
            <div
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="font-medium truncate">{todayColor.name}</p>
            ...
            <li key={hunt.dateKey}>
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="font-medium truncate">{hunt.colorName}</p>
